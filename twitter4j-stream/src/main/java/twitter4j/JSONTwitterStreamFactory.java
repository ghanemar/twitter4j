 ...
 * 
 * to return a MyTwitterStreamImpl
 * 
 * 
 */
 ...
 *
 * This is a slightly modified version of TwitterStreamFactory implemented by  Yusuke Yamamoto - yusuke at mac.com for Twitter4J 2.1.0
 * It allows the retun of JSONTwitterStream to allow the extraction of raw JSON objects from the stream
 * @author Amer Ghanem - amer at ghanem.ps
 * @since 
 */
public final class JSONTwitterStreamFactory implements java.io.Serializable {
     ...
     */
    public JSONTwitterStreamFactory() {
     ...
     */
    public JSONTwitterStreamFactory(Configuration conf) {
        this.conf = conf;
    }
     ...
     */
    public JSONTwitterStreamFactory(String configTreePath) {
    ...
    /**
     * Returns an Instance of JSONTwitterStreamImpl
     * 
     * @param conf
     * @param auth
     * @return an instance
     */
    private TwitterStream getInstance(Configuration conf, Authorization auth) {
        return new JSONTwitterStreamImpl(conf, auth);
    }
